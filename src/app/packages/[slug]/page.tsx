  ...
  return (
    <>
      ...
      <section className={`relative overflow-hidden bg-gradient-to-br ${accent.gradient} px-5 pb-20 pt-44 text-center text-white`}>
        <i
          aria-hidden
          className={`${category.icon} animate-float pointer-events-none absolute -right-6 -top-6 text-[180px] text-white/10 sm:text-[240px]`}
        />
        ...
        >
          <path d="M0 60 C 480 0 960 0 1440 60 L1440 60 L0 60 Z" fill="#0D1730" />
        </svg>
      </section>
